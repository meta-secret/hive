...
export class ReviewCommentBody {
  ...
  isExactHeadReviewRequestComment(): boolean {
    ...
    return (
      body.includes("<!-- hive-codex-review:") ||
      body.includes("<!-- hive-cursor-review:")
    );
  }
...
export class CursorReviewRevision {
  ...
  marker(): string {
    ...
    return `<!-- hive-cursor-review:${headSha} -->`;
  }
}
...
export class CodexReviewRevision {
  ...
  marker(): string {
    ...
    return `<!-- hive-codex-review:${headSha}:${baseSha} -->`;
  }
}
