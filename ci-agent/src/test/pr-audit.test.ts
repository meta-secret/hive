    ...
    const pulls = {
      get: async () => ({
        data: {
          ...
          html_url: "https://github.com/meta-secret/hive/pull/410",
      ...
      listFiles: async () => ({
        data: [{ filename: "worker/src/lib.rs" }],
      }),
            ...
            ? [
                {
                  ...
                  body: `@codex review\n\n<!-- hive-codex-review:${headSha}:base-sha -->`,
                  created_at: "2026-08-08T00:00:00Z",
                  id: 77,
                },
                ...(options.codexReview === MockCodexReview.DuplicateReaction
            ...
            data: {
              workflow_runs: [
                  ...
                  : []),
                {
                  ...
                  head_sha: headSha,
                  html_url:
                    "https://github.com/meta-secret/hive/actions/runs/42",
                  id: 42,
                  pull_requests: [
                    {
                      base: {
