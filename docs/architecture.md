...
- Shared-owner, mixed-owner, late-owner, future-owner, and genuine-completion
  ...
  `worker/tests/neo4j_store.rs` and its focused `rearm.rs`
...
- **Rust platform implementation:**
  [`worker/src/`](../../../../agentic-ai/minds/hive/src)
- **Task dependencies and artifact lineage:**
  [`neo4j.rs`](../worker/src/neo4j.rs) and
  [`migration.rs`](../worker/src/neo4j/migration.rs)
- **Worker image and cache stages:**
  [`agentic-ai/minds/hive/Dockerfile`](../worker/Dockerfile)
...
- **Hive verification workflow:**
  [`.github/workflows/hive.yml`](../.github/workflows/ci.yml)
